...
public class Application {
	...
	public void mainMenu() {
		...
		try {
			...
			System.out.println("잘못 입려하셨습니다. 다시 입력해주세요.");
			mainMenu();
		}
	...
	public void joinMembership() {
		...
		result = mc.joinMembership(id, new Member(password, name));
		if(result)
	...
	public void changePassword() {
		...
		result = mc.changePassword(id, oldPw, newPw);
	...
	public void changeName() {
		...
		memberName = mc.login(id, password);
		if(memberName != null) {
